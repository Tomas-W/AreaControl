...
class DisplayInterfaces(pygame.sprite.Group):
    ...
    def __init__(self, screen, background, player):
        ...
        # Key images
        self.key_red_image = pygame.transform.scale(KEY_RED_CAMERA_IMAGE, (40, 60))
        self.key_blue_image = pygame.transform.scale(KEY_BLUE_CAMERA_IMAGE, (40, 60))
        self.key_green_image = pygame.transform.scale(KEY_GREEN_CAMERA_IMAGE, (40, 60))
        self.key_yellow_image = pygame.transform.scale(KEY_YELLOW_CAMERA_IMAGE, (40, 60))
        # Item images
        ...
        self.key_list = [(self.key_red_image, "key_red"),
                         (self.key_blue_image, "key_blue"),
                         (self.key_green_image, "key_green"),
                         (self.key_yellow_image, "key_yellow")]
        self.current_key = random.choice(self.key_list)
    ...
    def show_stats(self):
        ...
        self.screen.blit(self.skull_image, (base_x,
                                            base_y + 50))
        skull_number = self.small_font.render(f"{self.player.skull_level:02}", True,
                                              GENERAL["white"])
        ...
        self.screen.blit(self.energy_image, (base_x + 85,
                                             base_y + 50))
        energy_number = self.small_font.render(f"{self.player.energy_level:02}", True,
                                               GENERAL["white"])
        ...
        self.screen.blit(self.health_potion_image, (base_x + 1220,
                                                    base_y + 45))
        health_potion_number = self.small_font.render(f"{self.player.total_health_potions:02}",
                                                      True,
                                                      GENERAL["white"])
        ...
        self.screen.blit(self.bomb_image, (base_x + 1320,
                                           base_y + 35))
        bomb_number = self.small_font.render(f"{self.player.total_bombs:02}", True,
                                             GENERAL["white"])
        ...
        self.screen.blit(self.portal_image, (base_x + 1440,
                                             base_y + 35))
        bomb_number = self.small_font.render(f"{self.player.total_portals:02}", True,
                                             GENERAL["white"])
    ...
    def show_bonus_timer(self, ticks):
        ...
        bonus_timer_text = self.small_font.render(f"Earn        {ticks // 60}", True,
                                                  GENERAL["white"])
        self.screen.blit(bonus_timer_text,
                         (base_x + 650, base_y + 50))

        self.screen.blit(self.current_key[0],
                         (base_x + 740, base_y + 25))
    ...
    def display_game_over(self):
        ...
        skull_collectors_killed_text = self.small_font.render(
            f"=  {self.player.kill_points['skull_collector'] * self.player.kills['skull_collector']}",
            True,
            GENERAL["white"])
        ...
        # Rusher points
        rushers_killed_text = self.small_font.render(
            f"=  {self.player.kill_points['rusher'] * self.player.kills['rusher']}", True,
            GENERAL["white"])
        ...
        # Bat points
        bats_killed_text = self.small_font.render(
            f"=  {self.player.kill_points['bat'] * self.player.kills['bat']}", True,
            GENERAL["white"])
        ...
        # Fish points
        fish_killed_text = self.small_font.render(
            f"=  {self.player.kill_points['fish'] * self.player.kills['fish']}", True,
            GENERAL["white"])
