...
skull_collector_walk_sheet_flipped = pygame.image.load(
    "images/enemies/skull_collector/skull_collector_walk_flipped.png").convert_alpha()
...
skull_collector_shoot_sheet = pygame.image.load(
    "images/enemies/skull_collector/skull_collector_shoot.png").convert_alpha()
...
skull_collector_shoot_sheet_flipped = pygame.image.load(
    "images/enemies/skull_collector/skull_collector_shoot_flipped.png").convert_alpha()
...
skull_collector_death_sheet = pygame.image.load(
    "images/enemies/skull_collector/skull_collector_death.png").convert_alpha()
...
skull_collector_death_sheet_flipped = pygame.image.load(
    "images/enemies/skull_collector/skull_collector_death_flipped.png").convert_alpha()
...
rusher_idle_sheet_flipped = pygame.image.load(
    "images/enemies/rusher/rusher_idle_flipped.png").convert_alpha()
...
rusher_run_sheet = pygame.image.load(
    "images/enemies/rusher/rusher_run.png").convert_alpha()
...
rusher_run_sheet_flipped = pygame.image.load(
    "images/enemies/rusher/rusher_run_flipped.png").convert_alpha()
...
rusher_strike_sheet = pygame.image.load(
    "images/enemies/rusher/rusher_strike.png").convert_alpha()
...
rusher_strike_sheet_flipped = pygame.image.load(
    "images/enemies/rusher/rusher_strike_flipped.png").convert_alpha()
...
rusher_death_sheet = pygame.image.load(
    "images/enemies/rusher/rusher_death.png").convert_alpha()
...
rusher_death_sheet_flipped = pygame.image.load(
    "images/enemies/rusher/rusher_death_flipped.png").convert_alpha()
